...
@implementation CommentTableViewCell9
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        //头像
        self.iconImageView=[[UIImageView alloc] initWithFrame:CGRectMake(15*PROPORTION_WIDTH, 10*PROPORTION_WIDTH, 32*PROPORTION_WIDTH, 32*PROPORTION_WIDTH)];
        
        [self addSubview:_iconImageView];
        _iconImageView.image=[UIImage imageNamed:@"头像"];
        //昵称
        self.nameLabel=[[UILabel alloc] initWithFrame:CGRectMake(29*PROPORTION_WIDTH+32*PROPORTION_WIDTH, 10*PROPORTION_WIDTH, 90*PROPORTION_WIDTH, 20*PROPORTION_WIDTH)];
        _nameLabel.text=@"刘语熙";
        _nameLabel.font=[UIFont systemFontOfSize:14*PROPORTION_WIDTH];
        _nameLabel.textColor=[self colorWithHexString:@"#999999"];
        [self addSubview:_nameLabel];
        //日期
        self.timeLabel=[[UILabel alloc] initWithFrame:CGRectMake(WIDTH-165*PROPORTION_WIDTH, 10*PROPORTION_WIDTH, 150*PROPORTION_WIDTH, 20*PROPORTION_WIDTH)];
        ...
        //评论
        self.commentLabel=[[UILabel alloc] initWithFrame:CGRectMake(29*PROPORTION_WIDTH+32*PROPORTION_WIDTH, 34*PROPORTION_WIDTH, WIDTH-61*PROPORTION_WIDTH-23*PROPORTION_WIDTH, 50*PROPORTION_WIDTH)];
