...
@interface KVideoPlayerControlView ()
...
@implementation KVideoPlayerControlView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self addSubview:self.weatingImageView];
...
- (void)layoutSubviews
{
    ...
    self.weatingImageView.frame = self.bounds;
...
- (UIImageView *)weatingImageView
{
    if (!_weatingImageView) {
        _weatingImageView = [[UIImageView alloc]init];
        _weatingImageView.backgroundColor = [UIColor clearColor];
    }
    return _weatingImageView;
}
