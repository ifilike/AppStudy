...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        //内容
        self.contentLabel=[[UILabel alloc] initWithFrame:CGRectMake(15*PROPORTION_WIDTH, 130*PROPORTION_WIDTH, WIDTH-30*PROPORTION_WIDTH, 50*PROPORTION_WIDTH)];
        ...
        NSString *labelText = @"如果你无法间接地表达你的想法,那只能说明你还不够了解它如果你无法间接地表达你的想法,那只能说明你还不够了解它如果你无法间接地表达你的想法,那只能说明你还不够了解它";
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    if ([keyPath isEqualToString:@"contentSize"]) {
        ...
        self.viewHigh=webViewHeight+20;
