...
@interface LinkTextViewController ()<ZJAttributeLabelDelegate>
...
{
    ZJAttributeLabel *label1 = [[ZJAttributeLabel alloc]initWithFrame:CGRectMake(0, 64, CGRectGetWidth(self.view.frame), 0)];
...
- (void)attributedLabel:(ZJAttributeLabel *)attributedLabel textStorageClicked:(id<ZJTextStorageProtocol>)TextRun atPoint:(CGPoint)point
{
    ...
    if ([TextRun isKindOfClass:[ZJLinkTextStorage class]]) {
        ...
        NSString *linkStr = ((ZJLinkTextStorage*)TextRun).linkData;
