...
@interface ImageTextViewController ()<ZJAttributeLabelDelegate>
@property (nonatomic,weak) ZJAttributeLabel *label1;
@property (nonatomic,weak) ZJAttributeLabel *label2;
...
- (void)addTextAttributedLabel1
{
    ...
    ZJImageStorage *imageStorageAlignLeft = [[ZJImageStorage alloc]init];
    imageStorageAlignLeft.imageName = @"CYLoLi";
    imageStorageAlignLeft.imageAlignment = ZJImageAlignmentLeft;
    ...
    ZJImageStorage *imageStorageAlignCenter = [[ZJImageStorage alloc]init];
    imageStorageAlignCenter.imageName = @"CYLoLi";
    imageStorageAlignCenter.imageAlignment = ZJImageAlignmentCenter;
    ...
    ZJImageStorage *imageStorageAlignRight = [[ZJImageStorage alloc]init];
    imageStorageAlignRight.imageName = @"CYLoLi";
    imageStorageAlignRight.imageAlignment = ZJImageAlignmentRight;
...
- (void)addTextAttributedLabel2
{
    ...
    ZJAttributeLabel *label = [[ZJAttributeLabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_label1.frame) + 20, CGRectGetWidth(self.view.frame), 0)];
    [_scrollView addSubview:label];
    label.delegate = self;
    ...
    // 属性文本生成器
    ZJTextContainer *attStringCreater = [[ZJTextContainer alloc]init];
