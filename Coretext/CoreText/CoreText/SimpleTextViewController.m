...
- (void)viewDidLoad {
    ...
    ZJAttributeLabel *label1 = [[ZJAttributeLabel alloc] init];
    ...
    ZJAttributeLabel *label2 = [[ZJAttributeLabel alloc]init];
    ...
    // label 垂直对齐方式
    // top text(default)
    ZJAttributeLabel *label3 = [[ZJAttributeLabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(label2.frame)+10, CGRectGetWidth(self.view.frame), 80)];
    ...
    // center text
    ZJAttributeLabel *label4 = [[ZJAttributeLabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(label3.frame)+10, CGRectGetWidth(self.view.frame), 80)];
    label4.text = @"\t总有一天你将破蛹而出，成长得比人们期待的还要美丽。(center text)";
    label4.backgroundColor = [UIColor lightGrayColor];
    // 垂直对齐方式
    label4.verticalAlignment = ZJVerticalAlignmentCenter;
    // 文字间隙
    ...
    // bottom text
    ZJAttributeLabel *label5 = [[ZJAttributeLabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(label4.frame)+10, CGRectGetWidth(self.view.frame), 80)];
    label5.text = @"\t总有一天你将破蛹而出，成长得比人们期待的还要美丽。(bottom text)";
    label5.backgroundColor = [UIColor lightGrayColor];
    // 垂直对齐方式
    label5.verticalAlignment = ZJVerticalAlignmentBottom;
    // 文字间隙
