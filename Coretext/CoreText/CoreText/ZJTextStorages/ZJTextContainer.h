...
@interface ZJTextContainer : NSObject
...
#pragma mark - append
@interface ZJTextContainer (Append)
...
#pragma mark - Link
@interface ZJTextContainer (Link)
...
@interface ZJTextContainer (UIImage)
...
@interface ZJTextContainer (UIView)
