...
NSString *const kZJTextRunAttributedName = @"ZJTextRunAttributedName";
...
- (BOOL)enumerateRunRectContainPoint:(CGPoint)point
                        ...
                        successBlock:(void (^)(id<ZJTextStorageProtocol> textStorage))successBlock;

- (BOOL)enumerateLinkRectContainPoint:(CGPoint)point
                           viewHeight:(CGFloat)viewHeight
                         successBlock:(void (^)(id<ZJLinkStorageProtocol> linkStorage))successBlock;

@end

@interface ZJAttributeLabel ()<UIGestureRecognizerDelegate>
{
    struct{
...
@implementation ZJAttributeLabel

#pragma mark - init
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        [self setupProperty];
        _textContainer = [[ZJTextContainer alloc] init];
    }
    return self;
}
...
-(instancetype)initWithTextContainer:(ZJTextContainer *)textContainer
{
    if (self = [super init]) {
        [self setupProperty];
...
-(void)setTextContainer:(ZJTextContainer *)attStringCreater
{
...
-(void)setDelegate:(id<ZJAttributeLabelDelegate>)delegate
{
...
{
    // draw storage
    [_textContainer enumerateDrawRectDictionaryUsingBlock:^(id<ZJDrawStorageProtocol> drawStorage, CGRect rect) {
        if ([drawStorage conformsToProtocol:@protocol(ZJViewStorageProtocol) ]) {
            [(id<ZJViewStorageProtocol>)drawStorage setOwnerView:self];
        }
...
-(void)singleTap:(UITapGestureRecognizer *)sender
{
    ...
    [_textContainer enumerateRunRectContainPoint:point viewHeight:CGRectGetHeight(self.frame) successBlock:^(id<ZJTextStorageProtocol> textStorage){
        if (_delegateFlags.textStorageClickedAtPoint) {
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([_textContainer existLinkRectDictionary]) {
        ...
        __typeof (self) __weak weakSelf = self;
        [_textContainer enumerateLinkRectContainPoint:point viewHeight:CGRectGetHeight(self.frame) successBlock:^(id<ZJLinkStorageProtocol> linkStorage) {
...
@implementation ZJAttributeLabel (AppendAttributedString)
...
@implementation ZJAttributeLabel (Link)
...
@implementation ZJAttributeLabel (UIImage)
...
@implementation ZJAttributeLabel (UIView)
